...
preprocess.py
=============
ML preprocessing pipeline for heap leaching surrogate training. Implements
...
2026.06.10  v1.1  HeapDataset: load all runs into RAM at init instead of
                  per-sample h5 reads. Eliminates bottleneck of 83,860
                  file opens per epoch. RAM cost ~171 MB (Strategy 1).
"""
