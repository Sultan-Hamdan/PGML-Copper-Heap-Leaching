...
generate_dataset.py
===================
Pipeline driver for Strategy 1 dataset generation. Reads 201 Q-schedules from existing MATLAB .mat files,
runs all 201 simulations through the GPU batch runner in one pass, and saves the results to a single HDF5 file.
